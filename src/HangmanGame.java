...
public class HangmanGame {
    public static void main(String[] args) {
        ...
        String category[] = {
                "sports","fruits"};
//        String sports[] = {
//                "football","volleyball","basketball","rugby","cricket"};
//        String fruits[] = {
//                "bananas","mangoes","apples","oranges","avocado"};
...
// Outputs "Looking forward to the Wee


            int randomNumber = random.nextInt(category.length); //random.nextInt(10);
            char randomWordToGuess[] = category[randomNumber].toCharArray(); // java -> j,a,v,a
